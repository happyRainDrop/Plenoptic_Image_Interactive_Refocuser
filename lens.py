...
This file is made by combining
 https://github.com/freerafiki/PlenopticToolbox2.0/blob/master/python/microlens/lens.py
and 
 https://github.com/freerafiki/PlenopticToolbox2.0/blob/master/python/camera/camera.py
